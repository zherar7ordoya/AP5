 public class Persona
...

  {
...

    {
      ...
      get { return _cotActual; }

      set { _cotActual = value; CambioCotizacion?.Invoke(this,new CambioCotizacionEventArg(this)); } 
...

  {
    ...
    public CambioCotizacionEventArg(Accion pAccion) { _accion = pAccion; }



    public decimal CotizacionActual { get { return _accion.CotActual; } }
