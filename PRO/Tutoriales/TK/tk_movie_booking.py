...
class Application(tk.Tk):
    ...
    def createTimeButtons(self, event=None):
        tk.Label(self, text='Select Time Slot', font='Roboto 11 bold underline').grid(row=4, column=2, columnspan=2,
                                                                                      pady=5)
        Time = tk.Frame(self)
    ...
    def seatSelection(self):
        ...
        tk.Button(window, text='Book Seat(s)', bg='black', fg='white', activebackground='black',
                  activeforeground='white', command=self.bookseat).grid(row=6, column=0, pady=10)
