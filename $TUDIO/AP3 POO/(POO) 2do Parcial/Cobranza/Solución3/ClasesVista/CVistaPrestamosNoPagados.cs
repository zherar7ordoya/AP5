...
{
    public class CVistaPrestamosNoPagados
    {
        #region Campos
        List<CVistaPrestamosNoPagados> lPrestamos;
        #endregion

        #region Constructores
        public CVistaPrestamosNoPagados() { lPrestamos = new List<CVistaPrestamosNoPagados>(); }

        public CVistaPrestamosNoPagados(string pIdentificador, decimal pCapital, DateTime pFechaAdjudicacion, int pPlazo, decimal pTasaInteres, decimal pInteres, decimal pTotal)
        ...
        #region Metodo
        public List<CVistaPrestamosNoPagados> PrestamosNoPagados(List<CPrestamo> pListaPrestamo)
        {
            lPrestamos.Clear();
            foreach (CPrestamo p in pListaPrestamo)
            {
                lPrestamos.Add(new CVistaPrestamosNoPagados(p.Identificador, p.Capital, p.FechaAdjudicacion, p.Plazo, p.TasaInteres, p.Interes, p.Total));
            }
            return lPrestamos;
        }
        #endregion
